...
<!--last-updated:start-->
**Last updated: 2025-06-22 15:12:31 UTC**
<!--last-updated:end-->
...
| <!--status:events/Eventdatastats-->🚨 [#177](https://github.com/ceviixx/umami-api-tests/issues/177)<!--status-end--> | [Event data stats](docs/events/event-data-stats.md) | Gets summarized website events, fields, and records within a given time range. |
| <!--status:events/Eventdatavalues-->✅<!--status-end--> | [Event data values](docs/events/event-data-values.md) | Gets event data counts for a given event and property |
